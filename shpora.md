...
многие рекурсивные алгоритмы описываются рекуррентой вида T(n) = aT(n/b) + f(n), где a ≥ 1 - кол-во рекурсивных вызовов, b > 1  
 - коэфицент деления размера задачи, f(n) - сложность работы на каждом уровне, мастер-теорема дает готовые условия для определения асимптотики таких рекуррент без их полного решения  
